                ...
                <Animated.View style={[styles.controls, { opacity: this.controlsFadeValue }]} pointerEvents={showControls ? undefined : "none"}>
                    <View style={styles.TopControlsBar}>
                        <TopControlsBar
                            ...
                            navpop={() => this.props.nav.pop()} toggleSettings={() => this.props.toggleSettings()} />
                    </View>
                    <View style={styles.middleControlsBar}>
                        <MiddleControlsBar {...middleControlsBarProps} currentTime={this.state.currentTime}  {...baseControlsBarProps} />
                    </View>
                    ...
                    this.props.Captions ? (
                        ...
                        <Video
                            ...
                            textTracks={[{
                                ...
                                uri: this.props.Captions
                            }]}


                            ref={player => (this.player = player)} source={{ uri: source }} style={styles.backgroundVideo} resizeMode="contain" paused={isPaused} onError={onError} onLoad={this.onLoad} onProgress={this.onProgress} onEnd={this.onEnd} />
                    ) : (
...
const styles = StyleSheet.create({
    ...
    TopControlsBar: Object.assign({}, StyleSheet.absoluteFillObject, {
        zIndex: 11,
        flexDirection: "row",
